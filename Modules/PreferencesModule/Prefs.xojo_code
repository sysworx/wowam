...
Private Class Prefs
	...
	#tag Method, Flags = &h0
		Function Load() As Boolean
		  ...
		  Dim prefName As String = mAppName + ".pref"
		  ...
		  If mPreferencesFile.Exists Then
		    ...
		    Dim data As String = input.ReadAll
		    input.Close
	...
	#tag Method, Flags = &h0
		Function Save() As Boolean
		  If mPreferencesFile <> Nil Then
		    Dim data As String = mPreferences.ToString
	...
	#tag Property, Flags = &h21
		Private mLogFile As FolderItem
	#tag EndProperty
